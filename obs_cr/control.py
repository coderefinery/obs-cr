...
def main():
    ...
    preset_d = Preset(f_presets, 'preset-d', "D", row=0, column=5)
    preset_b = Preset(f_presets, 'preset-b', "B", row=1, column=0)
    preset_e = Preset(f_presets, 'preset-e', "E", row=1, column=5)
    preset_c = Preset(f_presets, 'preset-c', "C", row=2, column=0)
